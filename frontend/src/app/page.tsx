...
const Philosophy = dynamic(() => import("@/components/landing/philosophy").then((m) => ({ default: m.Philosophy })), {
  loading: () => <SectionSkeleton />,
});
const Protocol = dynamic(() => import("@/components/landing/protocol").then((m) => ({ default: m.Protocol })), {
  loading: () => <SectionSkeleton />,
});
