...
// Deal Overview — top-level workspace page. Maps the design's six blocks
// onto live data from Supabase: KPI strip (derived stats), Project pulse
// (placeholder summary until the worker exposes a /deals/:id/summary
// endpoint), Recent meetings, Upcoming, Action items, and Activity.
