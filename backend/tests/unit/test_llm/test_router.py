"""Unit tests for Provider base classes, LLM dataclasses, and coverage gaps.
...
(LLMRouter routing/registration is covered by test_routing_validation.py against
the current API; the old gemini-era router tests here were removed as rot.)
"""
